...
export type FetchOrdersQuery = { __typename?: 'Query', userOrders?: { __typename?: 'OrdersPaginator', data: Array<{ __typename?: 'Order', id: string, status: OrderStatus, addressLine1: string, addressLine2?: string | null, city: string, province: string, postalCode: string, country: string, createdAt: any, currency: { __typename?: 'Currency', iso_code: string }, orderRows: Array<{ __typename?: 'OrderRow', amount: number } | null> } | null>, pagination: (
      { __typename?: 'Pagination' }
