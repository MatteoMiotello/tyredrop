...
export type FetchOrderQuery = { __typename?: 'Query', order: { __typename?: 'Order', id: string, addressLine1: string, addressLine2?: string | null, city: string, country: string, province: string, postalCode: string, status: OrderStatus, currency: { __typename?: 'Currency', iso_code: string, name: string }, userBilling: { __typename?: 'UserBilling', id: string, name: string, surname: string, vatNumber: string, fiscalCode: string, legalEntityType: { __typename?: 'LegalEntityType', name: string } }, orderRows: Array<{ __typename?: 'OrderRow', id: string, amount: number, quantity: number, productItem: { __typename?: 'ProductItem', id: string, product: { __typename?: 'Product', id: string, name?: string | null } } } | null> } };
...
export type FetchOrdersQuery = { __typename?: 'Query', userOrders?: Array<{ __typename?: 'Order', id: string, status: OrderStatus, addressLine1: string, addressLine2?: string | null, city: string, province: string, postalCode: string, country: string, currency: { __typename?: 'Currency', iso_code: string }, orderRows: Array<{ __typename?: 'OrderRow', amount: number } | null> } | null> | null };
...
export type ProductItemQuery = { __typename?: 'Query', productItem?: { __typename?: 'ProductItem', id: string, price: Array<{ __typename?: 'ProductPrice', value: number, currency: { __typename?: 'Currency', iso_code: string } } | null>, product: { __typename?: 'Product', code: string, name?: string | null, eprelProductCode?: string | null, brand: { __typename?: 'Brand', name: string, code: string }, productSpecificationValues: Array<{ __typename?: 'ProductSpecificationValue', value: string, specification: { __typename?: 'ProductSpecification', code: string, name: string } } | null> } } | null };
...
export type FetchUserQueryQuery = { __typename?: 'Query', userBilling?: { __typename?: 'UserBilling', id: string, name: string, surname: string, addressLine1: string, addressLine2?: string | null, city: string, country: string, province?: string | null, cap: string, fiscalCode: string, vatNumber: string, legalEntityType: { __typename?: 'LegalEntityType', name: string }, user: { __typename?: 'User', id: string, name?: string | null, surname?: string | null, email: string } } | null };
...
export type FetchUserQuery = { __typename?: 'Query', user?: { __typename?: 'User', id: string, name?: string | null, surname?: string | null, email: string, userBilling: { __typename?: 'UserBilling', id: string, name: string, surname: string, addressLine1: string, addressLine2?: string | null, city: string, country: string, province?: string | null, cap: string, fiscalCode: string, vatNumber: string, legalEntityType: { __typename?: 'LegalEntityType', name: string } } } | null };
