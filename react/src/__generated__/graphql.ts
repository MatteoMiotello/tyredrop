...
export type UserCartsQuery = { __typename?: 'Query', carts?: { __typename?: 'CartResponse', totalPrice?: { __typename?: 'TotalPrice', value: number, currency?: { __typename?: 'Currency', iso_code: string, symbol: string, name: string } | null } | null, items: Array<{ __typename?: 'Cart', id: string, quantity: number, productItemPrice: { __typename?: 'ProductItemPrice', value: number, priceAdditions: Array<{ __typename?: 'ProductItemPriceAddition', additionValue: number, priceAdditionType: { __typename?: 'PriceAdditionType', additionName: string, additionCode: string } } | null>, currency: { __typename?: 'Currency', iso_code: string }, productItem: { __typename?: 'ProductItem', id: string, product: { __typename?: 'Product', name?: string | null, code: string, brand: { __typename?: 'Brand', name: string } } } } } | null> } | null };
...
export type FetchOrdersQuery = { __typename?: 'Query', userOrders?: { __typename?: 'OrdersPaginator', data: Array<{ __typename?: 'Order', id: string, status: OrderStatus, addressName: string, addressLine1: string, addressLine2?: string | null, city: string, province: string, postalCode: string, country: string, createdAt: any, priceAmount: number, currency: { __typename?: 'Currency', iso_code: string }, orderRows: Array<{ __typename?: 'OrderRow', id: string, amount: number, quantity: number } | null> } | null>, pagination: (
      { __typename?: 'Pagination' }
