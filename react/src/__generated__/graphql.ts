...
export type OrderRowsQuery = { __typename?: 'Query', orderRows: Array<{ __typename?: 'OrderRow', id: string, amount: number, additionsAmount: number, quantity: number, productItemPrice: { __typename?: 'ProductItemPrice', id: string, value: number, currency: { __typename?: 'Currency', iso_code: string }, productItem: { __typename?: 'ProductItem', id: string, supplierPrice: number, product: { __typename?: 'Product', id: string, name?: string | null, code: string }, supplier: { __typename?: 'Supplier', id: string, name: string, code: string } } } }> };
...
export type StatsQuery = { __typename?: 'Query', stats: { __typename?: 'StatResponse', totalOrders: number, totalUsers: number, bestBrand: { __typename?: 'Brand', id: string, name: string } } };
