...
export type FetchOrderQuery = { __typename?: 'Query', order: { __typename?: 'Order', id: string, priceAmount: number, priceAmountTotal: number, taxesAmount: number, addressName: string, addressLine1: string, addressLine2?: string | null, city: string, country: string, province: string, postalCode: string, status: OrderStatus, createdAt: any, currency: { __typename?: 'Currency', iso_code: string, name: string }, payment?: { __typename?: 'Payment', id: string, amount: number, userPaymentMethod: { __typename?: 'UserPaymentMethod', id: string, paymentMethod: { __typename?: 'PaymentMethod', name: string, iban?: string | null, bank_name?: string | null, receiver?: string | null } } } | null, userBilling: { __typename?: 'UserBilling', id: string, name: string, surname: string, vatNumber: string, fiscalCode: string, legalEntityType: { __typename?: 'LegalEntityType', name: string } }, orderRows: Array<{ __typename?: 'OrderRow', id: string, amount: number, quantity: number, productItemPrice: { __typename?: 'ProductItemPrice', value: number, currency: { __typename?: 'Currency', iso_code: string, symbol: string }, productItem: { __typename?: 'ProductItem', id: string, product: { __typename?: 'Product', id: string, name?: string | null } } } } | null> } };
...
export type FetchOrdersQuery = { __typename?: 'Query', userOrders?: { __typename?: 'OrdersPaginator', data: Array<{ __typename?: 'Order', id: string, status: OrderStatus, addressName: string, addressLine1: string, addressLine2?: string | null, city: string, province: string, postalCode: string, country: string, createdAt: any, priceAmount: number, taxesAmount: number, priceAmountTotal: number, currency: { __typename?: 'Currency', iso_code: string }, orderRows: Array<{ __typename?: 'OrderRow', id: string, amount: number, quantity: number } | null> } | null>, pagination: (
      { __typename?: 'Pagination' }
