...
export type SearchValuesQuery = { __typename?: 'Query', searchSpecificationValue?: Array<{ __typename?: 'ProductSpecificationValue', value: string, specification: { __typename?: 'ProductSpecification', code: string } } | null> | null };

export type PriceMarkupsQueryVariables = Exact<{ [key: string]: never; }>;


export type PriceMarkupsQuery = { __typename?: 'Query', priceMarkups?: Array<{ __typename?: 'ProductPriceMarkup', id: string, markupPercentage: number, productCategory?: { __typename?: 'ProductCategory', id: string, name: string } | null, product?: { __typename?: 'Product', id: string, name?: string | null } | null, brand?: { __typename?: 'Brand', id: string, code: string, name: string } | null } | null> | null };
...
export const UpdateMarkupDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"updateMarkup"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"markupPercentage"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updatePriceMarkup"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}},{"kind":"Argument","name":{"kind":"Name","value":"markupPercentage"},"value":{"kind":"Variable","name":{"kind":"Name","value":"markupPercentage"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}}]} as unknown as DocumentNode<UpdateMarkupMutation, UpdateMarkupMutationVariables>;
