...
export const toSearchDataType = (req: TyreSearchFormRequest): ProductSearchDataType => {
    ...
    return {
        ...
        vehicleCode: req.vehicle_code?.length ? req.vehicle_code : null,
...
const TyreSearchForm: React.FC<TypeSpecificSearchFormProps> = (props) => {
    ...
    return <Form onSubmit={props.onSubmit} form={form}>
        <div className="col-span-2 flex items-center">
            <Field.FormControl>
                <SelectComponent options={[{value: "CAR", title: "Automobili"}]} name="vehicle_code"/>
            </Field.FormControl>
        </div>
        <div className="grid grid-cols-12 col-span-10 gap-4">
