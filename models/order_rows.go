...
type OrderRow struct {
	...
	Carrier        null.String `boil:"carrier" json:"carrier,omitempty" toml:"carrier" yaml:"carrier,omitempty"`
...
var OrderRowTableColumns = struct {
	...
	ProductID:      "order_rows.product_id",
	SupplierID:     "order_rows.supplier_id",
	Amount:         "order_rows.amount",
	TrackingNumber: "order_rows.tracking_number",
	Carrier:        "order_rows.carrier",
	SentAt:         "order_rows.sent_at",
...
var OrderRowWhere = struct {
	...
	Carrier        whereHelpernull_String
	...
	ProductID:      whereHelperint64{field: "\"order_rows\".\"product_id\""},
	SupplierID:     whereHelperint64{field: "\"order_rows\".\"supplier_id\""},
	Amount:         whereHelperint{field: "\"order_rows\".\"amount\""},
	TrackingNumber: whereHelpernull_String{field: "\"order_rows\".\"tracking_number\""},
	Carrier:        whereHelpernull_String{field: "\"order_rows\".\"carrier\""},
	SentAt:         whereHelpernull_Time{field: "\"order_rows\".\"sent_at\""},
...
func (r *orderRowR) GetProduct() *Product {
	if r == nil {
		return nil
	}
	return r.Product
...
func (r *orderRowR) GetSupplier() *Supplier {
	if r == nil {
		return nil
	}
	return r.Supplier
...
func (o *OrderRow) Product(mods ...qm.QueryMod) productQuery {
	queryMods := []qm.QueryMod{
...
func (o *OrderRow) Supplier(mods ...qm.QueryMod) supplierQuery {
	queryMods := []qm.QueryMod{
...
// loaded structs of the objects. This is for an N-1 relationship.
func (orderRowL) LoadProduct(ctx context.Context, e boil.ContextExecutor, singular bool, maybeOrderRow interface{}, mods queries.Applicator) error {
	var slice []*OrderRow
	var object *OrderRow
...
// loaded structs of the objects. This is for an N-1 relationship.
func (orderRowL) LoadSupplier(ctx context.Context, e boil.ContextExecutor, singular bool, maybeOrderRow interface{}, mods queries.Applicator) error {
	var slice []*OrderRow
	var object *OrderRow
...
// SetProduct of the orderRow to the related item.
// Sets o.R.Product to related.
// Adds o to related.R.OrderRows.
func (o *OrderRow) SetProduct(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Product) error {
	var err error
	if insert {
		if err = related.Insert(ctx, exec, boil.Infer()); err != nil {
			return errors.Wrap(err, "failed to insert into foreign table")
...
// SetSupplier of the orderRow to the related item.
// Sets o.R.Supplier to related.
// Adds o to related.R.OrderRows.
func (o *OrderRow) SetSupplier(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Supplier) error {
	var err error
	if insert {
		if err = related.Insert(ctx, exec, boil.Infer()); err != nil {
			return errors.Wrap(err, "failed to insert into foreign table")
