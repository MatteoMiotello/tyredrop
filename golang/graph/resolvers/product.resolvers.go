...
func (r *productCategoryResolver) Mandatory(ctx context.Context, obj *model.ProductCategory) (*bool, error) {
	panic(fmt.Errorf("not implemented: Mandatory - mandatory"))
}
func (r *productCategoryResolver) Searchable(ctx context.Context, obj *model.ProductCategory) (*bool, error) {
	panic(fmt.Errorf("not implemented: Searchable - searchable"))
}
