...
func (r *productPriceMarkupResolver) ProductCategory(ctx context.Context, obj *model.ProductPriceMarkup) (*model.ProductCategory, error) {
	if obj.ProductCategoryID == nil {
		return nil, nil
	}

	pc, err := r.ProductCategoryDao.FindCategoryById(ctx, *obj.ProductCategoryID)

	if err != nil {
		return nil, err
	}

	return converters.ProductCategoryToGraphQL(pc), nil
}

// Brand is the resolver for the brand field.
func (r *productPriceMarkupResolver) Brand(ctx context.Context, obj *model.ProductPriceMarkup) (*model.Brand, error) {
	if obj.BrandID == nil {
		return nil, nil
	}

	brand, err := r.BrandDao.FindOneById(ctx, *obj.BrandID)
...
// Product is the resolver for the product field.
func (r *productPriceMarkupResolver) Product(ctx context.Context, obj *model.ProductPriceMarkup) (*model.Product, error) {
...
// ProductPriceMarkup returns graph.ProductPriceMarkupResolver implementation.
func (r *Resolver) ProductPriceMarkup() graph.ProductPriceMarkupResolver {
	return &productPriceMarkupResolver{r}
}
...
type productPriceMarkupResolver struct{ *Resolver }
