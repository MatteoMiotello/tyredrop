...
var ProductSpecificationValueTableColumns = struct {
	...
	ProductID:              "product_specification_values.product_id",
...
var ProductSpecificationValueWhere = struct {
	...
	ProductID:              whereHelperint64{field: "\"product_specification_values\".\"product_id\""},
...
func (r *productSpecificationValueR) GetProduct() *Product {
	if r == nil {
		return nil
	}
	return r.Product
...
func (o *ProductSpecificationValue) Product(mods ...qm.QueryMod) productQuery {
...
func (productSpecificationValueL) LoadProduct(ctx context.Context, e boil.ContextExecutor, singular bool, maybeProductSpecificationValue interface{}, mods queries.Applicator) error {
...
// SetProduct of the productSpecificationValue to the related item.
// Sets o.R.Product to related.
// Adds o to related.R.ProductSpecificationValues.
func (o *ProductSpecificationValue) SetProduct(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Product) error {
	var err error
	if insert {
