...
var UserTableColumns = struct {
	...
	DefaultLanguageID: "users.default_language_id",
	Email:             "users.email",
...
func (r *userR) GetDefaultLanguage() *Language {
	if r == nil {
		return nil
	}
...
func (r *userR) GetUserRole() *UserRole {
	if r == nil {
		return nil
	}
	return r.UserRole
...
func (r *userR) GetUserPaymentMethods() UserPaymentMethodSlice {
	if r == nil {
		return nil
	}
...
// DefaultLanguage pointed to by the foreign key.
func (o *User) DefaultLanguage(mods ...qm.QueryMod) languageQuery {
	queryMods := []qm.QueryMod{
		qm.Where("\"id\" = ?", o.DefaultLanguageID),
	}
...
func (o *User) UserRole(mods ...qm.QueryMod) userRoleQuery {
	queryMods := []qm.QueryMod{
...
func (o *User) UserBillings(mods ...qm.QueryMod) userBillingQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"user_billings\".\"user_id\"=?", o.ID),
	)
...
func (o *User) UserPaymentMethods(mods ...qm.QueryMod) userPaymentMethodQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"user_payment_methods\".\"user_id\"=?", o.ID),
	)

	return UserPaymentMethods(queryMods...)
}

// LoadDefaultLanguage allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for an N-1 relationship.
func (userL) LoadDefaultLanguage(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	if singular {
		...
		args = append(args, object.DefaultLanguageID)
	...
	Outer:
		for _, obj := range slice {
			...
			for _, a := range args {
				if a == obj.DefaultLanguageID {
					continue Outer
				}
			}

			args = append(args, obj.DefaultLanguageID)
	...
	if singular {
		...
		object.R.DefaultLanguage = foreign
		if foreign.R == nil {
			foreign.R = &languageR{}
		}
		foreign.R.DefaultLanguageUsers = append(foreign.R.DefaultLanguageUsers, object)
		return nil
	}

	for _, local := range slice {
		for _, foreign := range resultSlice {
			if local.DefaultLanguageID == foreign.ID {
				local.R.DefaultLanguage = foreign
				if foreign.R == nil {
					foreign.R = &languageR{}
				}
				foreign.R.DefaultLanguageUsers = append(foreign.R.DefaultLanguageUsers, local)
				break
			}
		}
	}
...
// loaded structs of the objects. This is for an N-1 relationship.
func (userL) LoadUserRole(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadUserBillings(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadUserPaymentMethods(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		...
		qm.WhereIn(`user_payment_methods.user_id in ?`, args...),
...
// SetDefaultLanguage of the user to the related item.
// Sets o.R.DefaultLanguage to related.
// Adds o to related.R.DefaultLanguageUsers.
func (o *User) SetDefaultLanguage(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Language) error {
	var err error
	if insert {
	...
	o.DefaultLanguageID = related.ID
	if o.R == nil {
		o.R = &userR{
			DefaultLanguage: related,
		}
	} else {
		o.R.DefaultLanguage = related
	}

	if related.R == nil {
		related.R = &languageR{
			DefaultLanguageUsers: UserSlice{o},
		}
	} else {
		related.R.DefaultLanguageUsers = append(related.R.DefaultLanguageUsers, o)
	}
...
func (o *User) SetUserRole(ctx context.Context, exec boil.ContextExecutor, insert bool, related *UserRole) error {
	var err error
	if insert {
		if err = related.Insert(ctx, exec, boil.Infer()); err != nil {
			return errors.Wrap(err, "failed to insert into foreign table")
...
// Sets related.R.User appropriately.
func (o *User) AddUserPaymentMethods(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*UserPaymentMethod) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.UserID = o.ID
