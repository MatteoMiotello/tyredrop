...
var ProductWhere = struct {
	...
	ImageURL:          whereHelpernull_String{field: "\"products\".\"image_url\""},
}
...
func (r *productR) GetProductProductSpecificationValues() ProductProductSpecificationValueSlice {
	if r == nil {
		return nil
	}
...
var (
	productAllColumns            = []string{"id", "product_category_id", "brand_id", "product_code", "manufacturer_code", "eprel_updated_at", "completed", "deleted_at", "updated_at", "created_at", "vehicle_type_id", "name", "eprel_product_code", "image_url"}
	productColumnsWithoutDefault = []string{"product_category_id", "brand_id", "completed", "vehicle_type_id"}
	productColumnsWithDefault    = []string{"id", "product_code", "manufacturer_code", "eprel_updated_at", "deleted_at", "updated_at", "created_at", "name", "eprel_product_code", "image_url"}
...
func (o *Product) ProductProductSpecificationValues(mods ...qm.QueryMod) productProductSpecificationValueQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"product_product_specification_values\".\"product_id\"=?", o.ID),
	)
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (productL) LoadProductProductSpecificationValues(ctx context.Context, e boil.ContextExecutor, singular bool, maybeProduct interface{}, mods queries.Applicator) error {
	var slice []*Product
	var object *Product
	...
	query := NewQuery(
		...
		qm.WhereIn(`product_product_specification_values.product_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// Sets related.R.Product appropriately.
func (o *Product) AddProductProductSpecificationValues(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*ProductProductSpecificationValue) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.ProductID = o.ID
