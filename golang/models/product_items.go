...
func (r *productItemR) GetCarts() CartSlice {
	if r == nil {
		return nil
	}
	return r.Carts
...
func (r *productItemR) GetOrderRows() OrderRowSlice {
	if r == nil {
		return nil
	}
	return r.OrderRows
...
func (o *ProductItem) Carts(mods ...qm.QueryMod) cartQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"carts\".\"product_item_id\"=?", o.ID),
	)
...
func (o *ProductItem) OrderRows(mods ...qm.QueryMod) orderRowQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"order_rows\".\"product_item_id\"=?", o.ID),
	)
...
func (productItemL) LoadCarts(ctx context.Context, e boil.ContextExecutor, singular bool, maybeProductItem interface{}, mods queries.Applicator) error {
	var slice []*ProductItem
	var object *ProductItem
	...
	query := NewQuery(
		qm.From(`carts`),
		qm.WhereIn(`carts.product_item_id in ?`, args...),
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (productItemL) LoadOrderRows(ctx context.Context, e boil.ContextExecutor, singular bool, maybeProductItem interface{}, mods queries.Applicator) error {
	var slice []*ProductItem
	var object *ProductItem
	...
	query := NewQuery(
		qm.From(`order_rows`),
		qm.WhereIn(`order_rows.product_item_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *ProductItem) AddCarts(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Cart) error {
	var err error
...
// Sets related.R.ProductItem appropriately.
func (o *ProductItem) AddOrderRows(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*OrderRow) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.ProductItemID = o.ID
