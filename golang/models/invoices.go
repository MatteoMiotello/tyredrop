...
var (
	invoiceAllColumns            = []string{"id", "user_billing_id", "number", "file_path", "deleted_at", "updated_at", "created_at", "status"}
	invoiceColumnsWithoutDefault = []string{"user_billing_id", "number", "file_path"}
	invoiceColumnsWithDefault    = []string{"id", "deleted_at", "updated_at", "created_at", "status"}
