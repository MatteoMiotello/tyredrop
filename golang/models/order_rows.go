...
var OrderRowTableColumns = struct {
	...
	ProductItemID:  "order_rows.product_item_id",
...
var OrderRowWhere = struct {
	...
	ProductItemID:  whereHelperint64{field: "\"order_rows\".\"product_item_id\""},
...
func (r *orderRowR) GetProductItem() *ProductItem {
	if r == nil {
		return nil
	}
...
var (
	orderRowAllColumns            = []string{"id", "order_id", "product_item_id", "amount", "quantity", "tracking_number", "delivered_at", "updated_at", "created_at"}
	orderRowColumnsWithoutDefault = []string{"order_id", "product_item_id", "amount", "quantity"}
...
func (o *OrderRow) ProductItem(mods ...qm.QueryMod) productItemQuery {
	queryMods := []qm.QueryMod{
...
// loaded structs of the objects. This is for an N-1 relationship.
func (orderRowL) LoadProductItem(ctx context.Context, e boil.ContextExecutor, singular bool, maybeOrderRow interface{}, mods queries.Applicator) error {
	var slice []*OrderRow
	var object *OrderRow
...
// SetProductItem of the orderRow to the related item.
// Sets o.R.ProductItem to related.
// Adds o to related.R.OrderRows.
func (o *OrderRow) SetProductItem(ctx context.Context, exec boil.ContextExecutor, insert bool, related *ProductItem) error {
	var err error
	if insert {
		if err = related.Insert(ctx, exec, boil.Infer()); err != nil {
			return errors.Wrap(err, "failed to insert into foreign table")
