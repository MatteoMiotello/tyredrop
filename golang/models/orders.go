...
var (
	orderAllColumns            = []string{"id", "currency_id", "tax_id", "user_billing_id", "status", "address_line_1", "address_line_2", "city", "province", "country", "postal_code", "updated_at", "created_at", "address_name", "price_amount", "taxes_amount", "price_amount_total", "payment_id"}
	...
	orderColumnsWithDefault    = []string{"id", "address_line_2", "updated_at", "created_at", "address_name", "price_amount", "taxes_amount", "price_amount_total", "payment_id"}
