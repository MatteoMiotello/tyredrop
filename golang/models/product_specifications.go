...
type ProductSpecification struct {
	...
	Searchable        bool      `boil:"searchable" json:"searchable" toml:"searchable" yaml:"searchable"`
...
var ProductSpecificationTableColumns = struct {
	...
	Searchable:        "product_specifications.searchable",
}
...
var ProductSpecificationWhere = struct {
	...
	Searchable:        whereHelperbool{field: "\"product_specifications\".\"searchable\""},
}
...
var (
	productSpecificationAllColumns            = []string{"id", "product_category_id", "specification_code", "type", "mandatory", "deleted_at", "updated_at", "created_at", "searchable"}
	productSpecificationColumnsWithoutDefault = []string{"product_category_id", "specification_code", "type", "mandatory"}
	productSpecificationColumnsWithDefault    = []string{"id", "deleted_at", "updated_at", "created_at", "searchable"}
