...
var CurrencyRels = struct {
	...
	Orders:             "Orders",
	Payments:           "Payments",
	PriceAdditionTypes: "PriceAdditionTypes",
...
type currencyR struct {
	...
	PriceAdditionTypes PriceAdditionTypeSlice `boil:"PriceAdditionTypes" json:"PriceAdditionTypes" toml:"PriceAdditionTypes" yaml:"PriceAdditionTypes"`
...
func (r *currencyR) GetCurrencyLanguages() CurrencyLanguageSlice {
	if r == nil {
		return nil
	}
...
func (r *currencyR) GetLanguages() LanguageSlice {
	if r == nil {
		return nil
	}
	return r.Languages
...
func (r *currencyR) GetOrders() OrderSlice {
	if r == nil {
		return nil
	}
	return r.Orders
...
func (r *currencyR) GetPayments() PaymentSlice {
	if r == nil {
		return nil
	}
	return r.Payments
...
func (r *currencyR) GetPriceAdditionTypes() PriceAdditionTypeSlice {
	if r == nil {
		return nil
	}
	return r.PriceAdditionTypes
}

func (r *currencyR) GetProductItemPrices() ProductItemPriceSlice {
	if r == nil {
		return nil
	}
...
func (o *Currency) CurrencyLanguages(mods ...qm.QueryMod) currencyLanguageQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"currency_languages\".\"currency_id\"=?", o.ID),
	)
...
func (o *Currency) Languages(mods ...qm.QueryMod) languageQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"languages\".\"currency_id\"=?", o.ID),
	)
...
func (o *Currency) Orders(mods ...qm.QueryMod) orderQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"orders\".\"currency_id\"=?", o.ID),
	)
...
func (o *Currency) Payments(mods ...qm.QueryMod) paymentQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"payments\".\"currency_id\"=?", o.ID),
	)

	return Payments(queryMods...)
}

// PriceAdditionTypes retrieves all the price_addition_type's PriceAdditionTypes with an executor.
func (o *Currency) PriceAdditionTypes(mods ...qm.QueryMod) priceAdditionTypeQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"price_addition_types\".\"currency_id\"=?", o.ID),
	)
...
func (o *Currency) ProductItemPrices(mods ...qm.QueryMod) productItemPriceQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"product_item_prices\".\"currency_id\"=?", o.ID),
	)
...
func (currencyL) LoadCurrencyLanguages(ctx context.Context, e boil.ContextExecutor, singular bool, maybeCurrency interface{}, mods queries.Applicator) error {
	var slice []*Currency
	var object *Currency
	...
	query := NewQuery(
		...
		qm.WhereIn(`currency_languages.currency_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (currencyL) LoadLanguages(ctx context.Context, e boil.ContextExecutor, singular bool, maybeCurrency interface{}, mods queries.Applicator) error {
	var slice []*Currency
	var object *Currency
	...
	query := NewQuery(
		qm.From(`languages`),
		qm.WhereIn(`languages.currency_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (currencyL) LoadOrders(ctx context.Context, e boil.ContextExecutor, singular bool, maybeCurrency interface{}, mods queries.Applicator) error {
	var slice []*Currency
	var object *Currency
	...
	query := NewQuery(
		qm.From(`orders`),
		qm.WhereIn(`orders.currency_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (currencyL) LoadPayments(ctx context.Context, e boil.ContextExecutor, singular bool, maybeCurrency interface{}, mods queries.Applicator) error {
	var slice []*Currency
	var object *Currency
	...
	query := NewQuery(
		qm.From(`payments`),
		qm.WhereIn(`payments.currency_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// LoadPriceAdditionTypes allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (currencyL) LoadPriceAdditionTypes(ctx context.Context, e boil.ContextExecutor, singular bool, maybeCurrency interface{}, mods queries.Applicator) error {
	var slice []*Currency
	var object *Currency
	...
	query := NewQuery(
		...
		qm.WhereIn(`price_addition_types.currency_id in ?`, args...),
	...
	results, err := query.QueryContext(ctx, e)
	if err != nil {
		return errors.Wrap(err, "failed to eager load price_addition_types")
	}

	var resultSlice []*PriceAdditionType
	if err = queries.Bind(results, &resultSlice); err != nil {
		return errors.Wrap(err, "failed to bind eager loaded slice price_addition_types")
	}

	if err = results.Close(); err != nil {
		return errors.Wrap(err, "failed to close results in eager load on price_addition_types")
	}
	if err = results.Err(); err != nil {
	...
	if singular {
		object.R.PriceAdditionTypes = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.ID == foreign.CurrencyID {
				local.R.PriceAdditionTypes = append(local.R.PriceAdditionTypes, foreign)
				if foreign.R == nil {
					foreign.R = &priceAdditionTypeR{}
				}
				foreign.R.Currency = local
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (currencyL) LoadProductItemPrices(ctx context.Context, e boil.ContextExecutor, singular bool, maybeCurrency interface{}, mods queries.Applicator) error {
	var slice []*Currency
	var object *Currency
...
func (o *Currency) AddCurrencyLanguages(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*CurrencyLanguage) error {
	var err error
...
// Sets related.R.Currency appropriately.
func (o *Currency) AddLanguages(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Language) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.CurrencyID = o.ID
...
// Sets related.R.Currency appropriately.
func (o *Currency) AddOrders(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Order) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.CurrencyID = o.ID
...
// Sets related.R.Currency appropriately.
func (o *Currency) AddPayments(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Payment) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.CurrencyID = o.ID
...
// AddPriceAdditionTypes adds the given related objects to the existing relationships
// of the currency, optionally inserting them as new records.
// Appends related to o.R.PriceAdditionTypes.
// Sets related.R.Currency appropriately.
func (o *Currency) AddPriceAdditionTypes(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*PriceAdditionType) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.CurrencyID = o.ID
	...
	if o.R == nil {
		o.R = &currencyR{
			PriceAdditionTypes: related,
		}
	} else {
		o.R.PriceAdditionTypes = append(o.R.PriceAdditionTypes, related...)
	}

	for _, rel := range related {
		if rel.R == nil {
			rel.R = &priceAdditionTypeR{
				Currency: o,
			}
		} else {
			rel.R.Currency = o
...
// Sets related.R.Currency appropriately.
func (o *Currency) AddProductItemPrices(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*ProductItemPrice) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.CurrencyID = o.ID
...
func FindCurrency(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*Currency, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"currencies\" where \"id\"=$1", sel,
	)
...
func (o *Currency) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert currencies")
	}
...
func CurrencyExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"currencies\" where \"id\"=$1 limit 1)"
