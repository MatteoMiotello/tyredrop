...
var (
	productPriceMarkupAllColumns            = []string{"id", "product_category_id", "brand_id", "product_id", "markup_percentage", "deleted_at", "updated_at", "created_at"}
	productPriceMarkupColumnsWithoutDefault = []string{"markup_percentage"}
	productPriceMarkupColumnsWithDefault    = []string{"id", "product_category_id", "brand_id", "product_id", "deleted_at", "updated_at", "created_at"}
