...
var CartTableColumns = struct {
	...
	ProductItemID: "carts.product_item_id",
...
var CartWhere = struct {
	...
	ProductItemID: whereHelperint64{field: "\"carts\".\"product_item_id\""},
...
func (r *cartR) GetProductItem() *ProductItem {
	if r == nil {
		return nil
	}
...
var (
	cartAllColumns            = []string{"id", "user_id", "product_item_id", "quantity", "deleted_at", "updated_at", "created_at"}
	cartColumnsWithoutDefault = []string{"user_id", "product_item_id", "quantity"}
...
func (o *Cart) ProductItem(mods ...qm.QueryMod) productItemQuery {
...
func (cartL) LoadProductItem(ctx context.Context, e boil.ContextExecutor, singular bool, maybeCart interface{}, mods queries.Applicator) error {
	var slice []*Cart
	var object *Cart
...
// SetProductItem of the cart to the related item.
// Sets o.R.ProductItem to related.
// Adds o to related.R.Carts.
func (o *Cart) SetProductItem(ctx context.Context, exec boil.ContextExecutor, insert bool, related *ProductItem) error {
	var err error
	if insert {
